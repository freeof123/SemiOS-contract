...
contract PDMintNftTest is DeployHelper {
    ...
    function test_PreuploadedWorksShouldOccupy1to1000TokenIds() public {
        ...
        //     tokenId = _mintNft(daoId, param.canvasId, "test token uri 1", 0.01 ether, daoCreator.key,
        // nftMinter.addr);
        ...
        //     );
        //     assertEq(tokenId, 2);
        //     tokenId = _mintNft(daoId, param.canvasId, "test token uri 2", 0.01 ether, daoCreator.key,
        // nftMinter.addr);
