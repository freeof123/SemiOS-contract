...
contract NftPriceTest is DeployHelper {
    ...
    function test_setDaoFloorPrice_PriceShouldChangeCorrectly() public {
        ...
        assertEq(protocol.getCanvasNextPrice(canvasId1), 0.91 ether);
        assertEq(protocol.getCanvasNextPrice(canvasId2), 0.01 ether);
        assertEq(protocol.getCanvasNextPrice(canvasId3), 0.01 ether);
        ...
        assertEq(protocol.getCanvasNextPrice(canvasId1), 0.91 ether);
        assertEq(protocol.getCanvasNextPrice(canvasId2), 0.03 ether);
        assertEq(protocol.getCanvasNextPrice(canvasId3), 0.03 ether);
        ...
        assertEq(protocol.getCanvasNextPrice(canvasId3), 0.05 ether);
    ...
    function test_PriceUnderDfpShouldElevateToDfpAfterMint() public {
        ...
        //     daoId, 1, 5, 2, PriceTemplateType.LINEAR_PRICE_VARIATION, 1_700_000_000_000_000, 2800, 5000, 2000, 300,
        // 800
        // );
