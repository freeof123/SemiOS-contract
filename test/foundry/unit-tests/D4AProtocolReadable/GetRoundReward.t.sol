...
contract GetRoundRewardTest is DeployHelper {
        ...
        public
    {
        ...
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 1), 500_000_000_465_661_287_741_420_127);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 2), 750_000_000_698_491_931_612_130_190);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 3), 875_000_000_814_907_253_547_485_222);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 18), 999_996_186_234_053_397_769_158_144);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 30), 999_999_999_999_999_999_999_999_999);
        ...
        public
    {
        ...
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 18), 999_996_185_302_734_375_000_000_000);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 30), 999_999_999_068_677_425_384_521_484);
    ...
    function test_getRoundReward_Exponential_reward_issuance_2dot65x_decayFactor_ProgressiveJackpot_30_mintableRounds()
        public
    {
        _createDaoAndCanvas(30, RewardTemplateType.EXPONENTIAL_REWARD_ISSUANCE, 26_500, true);

        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 1), 622_641_509_434_087_250_289_909_344);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 2), 857_600_569_597_893_759_833_271_359);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 3), 946_264_365_886_122_631_359_068_346);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 18), 999_999_975_924_758_731_203_841_883);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 30), 999_999_999_999_999_999_999_999_999);
        vm.expectRevert(ExceedMaxMintableRound.selector);
        ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 31);
    }

    function test_getRoundReward_Exponential_reward_issuance_2dot65x_decayFactor_ProgressiveJackpot_max_mintableRounds()
        public
    {
        _createDaoAndCanvas(366, RewardTemplateType.EXPONENTIAL_REWARD_ISSUANCE, 26_500, true);

        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 1), 622_641_509_433_962_264_150_943_397);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 2), 857_600_569_597_721_609_113_563_546);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 3), 946_264_365_885_932_682_684_363_602);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 18), 999_999_975_924_557_995_894_577_851);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 30), 999_999_999_999_799_264_685_903_216);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 100), 1e27);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 200), 1e27);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 300), 1e27);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 366), 1e27);
    ...
    function test_getRoundReward_Exponential_reward_issuance_1dot5x_decayFactor_ProgressiveJackpot_30_mintableRounds()
        public
    {
        ...
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 2), 555_558_452_845_693_447_105_242_009);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 3), 703_707_373_604_545_032_999_973_211);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 18), 999_328_572_108_891_710_282_000_512);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 30), 999_999_999_999_999_999_999_999_998);
        vm.expectRevert(ExceedMaxMintableRound.selector);
        ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 31);
    }

    function test_getRoundReward_Exponential_reward_issuance_1dot5x_decayFactor_ProgressiveJackpot_max_mintableRounds()
        public
    {
        _createDaoAndCanvas(366, RewardTemplateType.EXPONENTIAL_REWARD_ISSUANCE, 15_000, true);

        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 1), 333_333_333_333_333_333_333_333_334);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 2), 555_555_555_555_555_555_555_555_556);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 3), 703_703_703_703_703_703_703_703_704);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 18), 999_323_360_515_401_135_637_924_405);
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 30), 999_994_784_904_949_153_436_736_982);
        assertEq(
    ...
    function test_getRoundReward_Linear_reward_issuance_ProgressiveJackpot_30_mintableRounds() public {
        ...
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 1), 33_333_333_333_333_333_333_333_333);
        assertEq(
        ...
        assertEq(
            ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 18), 33_333_333_333_333_333_333_333_333 * 18
        );
        assertEq(ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 30), 999_999_999_999_999_999_999_999_990);
        vm.expectRevert(ExceedMaxMintableRound.selector);
        ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 31);
    }
    ...
    function test_getRoundReward_Linear_reward_issuance_ProgressiveJackpot_max_mintableRounds() public {
        ...
        assertEq(
            ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 200), 273_224_043_715_846_994_535_519_100 * 2
        );
        assertEq(
            ID4AProtocolReadable(address(protocol)).getRoundReward(daoId, 300), 273_224_043_715_846_994_535_519_100 * 3
        );
        assertEq(
