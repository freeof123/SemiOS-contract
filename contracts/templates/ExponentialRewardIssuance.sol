...
abstract contract ExponentialRewardIssuance is RewardTemplateBase {
    /**
    ...
    function getRoundReward(bytes32 daoId, uint256 round) public view virtual override returns (uint256 rewardAmount) {
        ...
        // rewardInfo.rewardCheckpoints[rewardCheckpointIndex];
        ...
        //         // kn is 27 decimal for now
        //         uint256 oneOverKn =
        //             MathMate.rpow(1e27 * BASIS_POINT / rewardInfo.rewardDecayFactor, rewardCheckpoint.totalRound,
        // 1e27);
        //         uint256 beginReward = rewardCheckpoint.totalReward
        //             * (1e27 - 1e27 * BASIS_POINT / rewardInfo.rewardDecayFactor) / (1e27 - oneOverKn);
        ...
        //                 - beginReward * (1e27 - oneOverKn) / (1e27 - 1e27 * BASIS_POINT /
        // rewardInfo.rewardDecayFactor);
        //         }
        //         // use `rewardCheckpointIndexOfLastActiveRound` to iterate all reward checkpoints but the fist one
        // and
        //         // the last one, here use `rewardCheckpointIndexOfLastActiveRound + 2 < rewardCheckpointIndex`
        // instead
        ...
        //             rewardAmount += rewardInfo.rewardCheckpoints[rewardCheckpointIndexOfLastActiveRound +
        // 1].totalReward;
        //             unchecked {
        ...
        //             oneOverKn = MathMate.rpow(
        //                 1e27 * BASIS_POINT / rewardInfo.rewardDecayFactor, round + 1 - rewardCheckpoint.startRound,
        // 1e27
        //             );
        //             rewardAmount +=
        //                 beginReward * (1e27 - oneOverKn) / (1e27 - 1e27 * BASIS_POINT /
