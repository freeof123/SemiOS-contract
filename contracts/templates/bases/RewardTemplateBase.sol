...
abstract contract RewardTemplateBase is IRewardTemplate {
    ...
    //                 roundReward * rewardInfo.protocolWeights[activeRounds[j]] /
    ...
    //             if (
    //                 rewardInfoTemp.rewardIssuePendingRound != 0 && currentRound >
    // rewardInfoTemp.rewardIssuePendingRound
    //             ) {
    //                 uint256 roundReward = getRoundReward(treeInfo.familyDaos[i],
    // rewardInfoTemp.rewardIssuePendingRound);
